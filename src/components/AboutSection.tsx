      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto mt-12">
          <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-2xl font-bold text-acg-navy mb-4">Our History</h3>
        ...
        {/* Team Section */}
        <div className="max-w-4xl mx-auto mt-12">
          <div className="bg-acg-lightgray p-8 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-acg-navy mb-4 text-center">Our Team</h3>
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h4 className="text-xl font-bold text-acg-navy mb-2">Fadi Abdallah</h4>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h4 className="text-xl font-bold text-acg-navy mb-2">Kevin Abdallah</h4>
                <p className="text-gray-700">
        ...
        <div className="mt-16">
          <div className="bg-white p-8 rounded-lg border border-gray-200">
            <h3 className="text-2xl font-bold text-acg-navy mb-4">Our Mission</h3>
            <p className="text-gray-700">
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-bold text-acg-navy mb-6 text-center">Our Core Values</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {coreValues.map((value, index) => (
              <div key={index} className="bg-white border border-gray-200 p-4 rounded-lg flex items-start">
                <div className="text-acg-navy mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <p className="font-semibold text-acg-navy">{value}</p>
              </div>
            ))}
          </div>
        </div>
