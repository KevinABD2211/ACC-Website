        ...
        <div className="container mx-auto">
          ...
          <div className="mt-12">
            <div className="relative">
              {/* Connection Line */}
              <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-acg-navy bg-opacity-20 z-0"></div>
              ...
              <div className="space-y-16 relative z-10">
                {processSteps.map((step, index) => (
                  <div key={step.id} className={`flex flex-col md:flex-row ${index % 2 === 0 ? '' : 'md:flex-row-reverse'} items-center`}>
                    {/* Step Number + Icon */}
                    <div className="flex-shrink-0 w-24 h-24 bg-white rounded-full border-4 border-acg-navy flex items-center justify-center mb-6 md:mb-0 relative">
                      <div className="absolute inset-0 flex items-center justify-center">
                        {step.icon}
                      </div>
                      <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-acg-gold text-white flex items-center justify-center font-bold">
                        {step.id}
                      </div>
                    </div>
                    ...
                    <div className={`md:w-1/2 ${index % 2 === 0 ? 'md:ml-12' : 'md:mr-12'} bg-white p-6 rounded-lg shadow-md`}>
                      <h3 className="text-xl font-bold text-acg-navy mb-2">{step.title}</h3>
          ...
          <div className="mt-20 bg-acg-lightgray p-8 rounded-lg">
            <h3 className="text-2xl font-bold text-acg-navy mb-4 text-center">Our Turnkey Promise</h3>
